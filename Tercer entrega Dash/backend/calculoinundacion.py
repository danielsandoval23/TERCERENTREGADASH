...
departamentos = gpd.read_file('C:/Users/KDSL/Downloads/Departamentos.zip')


#importamos el archivo de DrenajeDoble
rios = gpd.read_file('C:/Users/KDSL/Downloads/DrenajeDoble.zip')


#importamos el archivo de colegios
colegios = gpd.read_file('C:/Users/KDSL/Downloads/EstablecimientosEducativos.zip')
